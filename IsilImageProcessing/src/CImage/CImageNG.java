...
public final class CImageNG extends CImage 
{
    /** Creates a new instance of CImage
     * @param la
     * @param ha
     * @param val
     * @throws CImage.Exceptions.CImageNGException */
     ...
     */
    @Override
    public CImageNG clone() throws CloneNotSupportedException
    {
        CImageNG cImageNG;
        try 
        { 
    ...
    public CImageRGB getCImageRGB()
    {
        ...
        catch (CImageNGException | CImageRGBException ex) { System.err.println("Erreur interne inexpliq�e..."); }
        return null;
    }
}
